...
import { Drawer, Button, AutoComplete , List, Avatar, Form, Tooltip} from "antd";
...
const ProjectTeam = ({ setVisible, visible }) => {
  ...
  return (
    ...
    >
      ...
      <Form.Item name="selectEmploye"         style={{
          width: "80%",
        }}>
      <AutoComplete
        options={options}
          ...
          {(item) => (
            <div>
              <List.Item  key={item.email}>
                <List.Item.Meta
                  avatar={
                    <Avatar src={item.photo} style={{ marginLeft: "10px", marginTop:'8px' }} />
                  }
