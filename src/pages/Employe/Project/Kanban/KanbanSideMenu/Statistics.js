...
const Statistics = ({ setVisible, visible }) => {
  ...
  return (
    ...
    >
      ...
      <Progress width={100} type="circle" percent={50} strokeColor={getColor(50)} format={() => `42 Days`} style={{ marginTop:'10px'}}/>
      </div>
      <div style={{width:"50%", textAlign:'center'}}>
        <span style={{fontWeight:'bold'}}>Project progress</span>
      <Progress width={100} type="circle" percent={80} strokeColor={getColor(80)} style={{ marginTop:'10px'}}/>
      </div>
      </div>
      ...
      <div >
      <span style={{fontWeight:'bold'}}>projcet timeline </span>
      <Timeline mode="left" style={{textAlign:"center", marginTop:"10px"}}>
